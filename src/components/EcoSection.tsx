      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          <div className="flex-1">
            ...
            <p className="text-[#5a6e78] text-lg mb-8 leading-relaxed">
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[#3a4d54] leading-relaxed">Materials sorted and sent to certified recycling partners</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-3.5 h-3.5 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-[#3a4d54] leading-relaxed">Reduced landfill waste through responsible processing</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-3.5 h-3.5 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-[#3a4d54] leading-relaxed">Full compliance with local environmental regulations</span>
              </li>
            </ul>
          </div>
        </div>
