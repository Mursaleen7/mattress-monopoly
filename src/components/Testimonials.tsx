        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div
              ...
              className="bg-white rounded-2xl p-8 shadow-md border border-gray-200 hover:shadow-xl hover:border-[#0055FF] transition-all duration-500 ease-out transform hover:-translate-y-1"
            >
