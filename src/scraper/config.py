...
# Support both SERPER_API_KEY (serper.dev) and SERPAPI_KEY (serpapi.com)
SERPER_API_KEY = os.getenv('SERPER_API_KEY')
SERPAPI_KEY = os.getenv('SERPAPI_KEY')

# Use whichever is available
SEARCH_API_KEY = SERPER_API_KEY or SERPAPI_KEY
USE_SERPER = bool(SERPER_API_KEY)  # Flag to determine which API to use

if not SEARCH_API_KEY:
    print("WARNING: No search API key found (SERPER_API_KEY or SERPAPI_KEY)")
    print("Scraper will work but may miss some official sources")
